...
namespace WpfApp1.utils
{
    class SQLiteHelper
    {
        ...
        public SQLiteHelper(string pathStr)
        {
            connString = "Data Source=" + pathStr + ";Version=3";
        }
        ...
        static string connstr = Application.StartupPath + "\\db\\configure.db3";
        public static string connectionString = "Data Source=" + connstr + ";Version=3";
        ...
        /// <returns></returns>
        public static ArrayList Execute_Reader(string strSQL)
        {
            ...
            {
                connection.Open();
                SQLiteDataReader myReader = cmd.ExecuteReader();//.ExecuteReader(CommandBehavior.CloseConnection);
                ArrayList alist = new ArrayList();
                if (myReader.HasRows == false)
                {
                    return null;
                }
                int a = myReader.FieldCount;
                while (myReader.Read())
                {
            ...
            {
                //LOG.LogOut.Error("ExecuteReader: " + e.Message);
                throw e;
            }
            finally
            {
        ...
        public SQLiteDataReader ExecuteReader(string strSQL)
        {
            ...
            {
                Console.WriteLine("ExecuteReader: " + e.Message);
                throw e;
            }
            finally
            {
        ...
        public static ArrayList ExecuteReader1(string strSQL)
        {
            SQLiteConnection connection = new SQLiteConnection(connectionString);
            SQLiteCommand cmd = new SQLiteCommand(strSQL, connection);
            try
        ...
        public static int QueryOneData(string SQLString)
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                int count = 0;
                try
                {
                    ...
                    count = Convert.ToInt16(command.ExecuteScalar());//..Fill(ds, "ds");
                    connection.Close();
                }
                catch (SQLiteException ex)
                {
                    Console.WriteLine("ExecuteReader: " + ex.ToString());
        ...
        public static DataSet QueryToDataset(string SQLString)
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
